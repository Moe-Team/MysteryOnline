...
class MOPopup(Popup):
    ...
    def __init__(self, title_, msg, btn_msg, dismissable=True, btn_command=None, *args, **kwargs):
        ...
        if dismissable or btn_command is not None:
            ...
            if dismissable:
                btn_command = self.add_dismiss_to_command(btn_command)               
    ...
    def add_dismiss_to_command(self, btn_command):
